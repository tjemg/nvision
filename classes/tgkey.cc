...
int    TGKey::Mode=0;
char const *TGKey::KeyNames[] = { "Unknown",
...
static const char altCodes[CantDef+1]= "\0ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]\0\0""0123456789\0\t\0;'`,./*\xf0-+\0=";
...
*/
stIntCodePairs TGKey::GreekKeyboard[]= { // With tonos
...
stIntCodePairs TGKey::RussianKeyboard[]= { { 0x0410,'F' },{ 0x0411,'<' },{ 0x0412,'D' },{ 0x0413,'U' },{ 0x0414,'l' },
...
const uchar TGKey::kbByASCII[128]= { 0,kbA,kbB,kbC,kbD,kbE,kbF,kbG,
