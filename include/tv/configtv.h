...
#define TVCONFIG_TVSRC "../../include /root/Downloads/tv203/contrib/tvision/include /usr/include/rhtvision "
#define TVCONFIG_RHIDE_OS_LIBS "stdc++ ncurses m gpm X11 Xmu"
#define TVCONFIG_TVOBJ "/usr/lib ../../makes /root/Downloads/tv203/contrib/tvision/makes /usr/X11R6/lib "
...
#define TVCONFIG_CFLAGS   "-O2 -pipe"
#define TVCONFIG_CXXFLAGS "-O2 -pipe"
#define TVCONFIG_REF_DIR  "/root/Downloads/tv203/contrib/tvision"
